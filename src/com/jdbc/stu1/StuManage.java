...
import com.jdbc.SqlHelper.StuAddDialog;
import com.jdbc.SqlHelper.StuModel;
import com.jdbc.SqlHelper.StuUpdateDialog;
 ...
 */
public class StuManage extends JPanel implements ActionListener{
...
//            stuModel = new StuModel();
//            String[] paras2 = {"1"};
//            stuModel.queryStu("select * from stu where 1=?",paras2);
//            //更新JTable
//            jTable.setModel(stuModel);
//
...
//            jTable.setModel(stuModel);
            ...
            temp.updateStu(sql, paras);
                ...
                stuModel = new StuModel();
                stuModel.queryStu("select * stu from where 1=?",paras2);
